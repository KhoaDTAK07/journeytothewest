...
class UserScheduleHistoryPage extends StatelessWidget {
  final UserScheduleHistoryViewModel model;

  UserScheduleHistoryPage({this.model});

  @override
  Widget build(BuildContext context) {
    return ScopedModel<UserScheduleHistoryViewModel>(
      model: model,
      child: Scaffold(
        appBar: new AppBar(
        ...
        body: Column(
          children: <Widget>[
            ScopedModelDescendant<UserScheduleHistoryViewModel>(
  ...
  Widget _drawSlidable(BuildContext context, UserScheduleHistoryViewModel model) {
  ...
  Widget _getListScenario(
      BuildContext context, int index, UserScheduleHistoryViewModel model) {
    return Column(
      children: <Widget>[
        Container(
