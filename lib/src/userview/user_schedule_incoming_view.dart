...
class UserScheduleInComingPage extends StatelessWidget {
  final UserScheduleInComingViewModel model;

  UserScheduleInComingPage({this.model});

  @override
  Widget build(BuildContext context) {
    return ScopedModel<UserScheduleInComingViewModel>(
      model: model,
      child: Scaffold(
        appBar: new AppBar(
        ...
        body: Column(
          children: <Widget>[
            ScopedModelDescendant<UserScheduleInComingViewModel>(
  ...
  Widget _drawSlidable(BuildContext context, UserScheduleInComingViewModel model) {
  ...
  Widget _getListScenario(
      BuildContext context, int index, UserScheduleInComingViewModel model) {
    return Column(
      children: <Widget>[
        Container(
